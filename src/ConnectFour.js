        ...
        render(){
          return (
            <div style={{textAlign:'center'}}>
              <h1>{this.state.winner > 0 ?  this.state.winner == 1? "Yay!! Player 2 won":"Yay!! Player 1 won": 
                   this.state.player? "Player 2's  Turn" : "Player 1's Turn"} </h1>
                <Board cells = {this.state.cells} handleClick = {this.handleClick}/>
                <button style={{padding: "10px", margin:"10px"}}   onClick = { () => this.restart()}>Restart</button>
            </div>
            )
        }
      }
